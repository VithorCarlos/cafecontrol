...
class Email
{
    ...
    public function __construct()
    {
        ...
        //setup
        $this->mail->isSMTP();
        $this->mail->setLanguage(CONF_MAIL_OPTION_LANGUAGE);
        ...
        //auth
        $this->mail->Host = CONF_MAIL_OPTION_HOST;
        $this->mail->Port = CONF_MAIL_OPTION_PORT;
        $this->mail->Username = CONF_MAIL_OPTION_USERNAME;
        $this->mail->Password = CONF_MAIL_OPTION_PASS;
    }

...
<head>
    <meta charset="UTF-8">
        <meta name="mit" content="2021-05-10T22:58:56-03:00+184065">
    <meta name="viewport" content="width=device-width,initial-scale=1">

    <title>CafeControl - Gerencie suas contas com um bom café</title>
    <link rel="icon" type="image/png" href="<?= theme("/assets/images/favicon.png"); ?>"/>
    <link rel="stylesheet" href="<?= theme("/assets/style.css"); ?>"/>
<!--    quando quiser colocar um estilo aqui, basta abrir essa sessão com start e end, em qualquer lugar, e automaticamente
eu trago o estilo para dentro do template no local correto-->
<?= $v->section("styles"); ?>
</head>
<body>
    ...
    <div class="container">
        ...
        <nav class="main_header_nav">
            ...
            <div class="main_header_nav_links j_menu_mobile_tab">
                ...
                <a class="link transition radius active" title="Home" href="<?= url("home")?>">Home</a>
...
<?php else: ?>
    <article class="footer_optout">
        <div class="footer_optout_content content">
            ...
            <a href="<?= url()?>" class="footer_optout_btn gradient gradient-green gradient-hover radius icon-check-square-o">Quero controlar</a>
        </div>
    </article>
<?php endif; ?>
